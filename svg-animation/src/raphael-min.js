!(function t(e, r) {
  'object' == typeof exports && 'object' == typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define([], r)
      : 'object' == typeof exports ? (exports.Raphael = r()) : (e.Raphael = r())
})(this, function() {
  return (function(t) {
    function e(i) {
        ...
        (n = function(t) {
          ...
          ;(e.getRGB = n(function(t) {
            if (!t || (t = I(t)).indexOf('-') + 1)
              return {r: -1, g: -1, b: -1, hex: 'none', error: 1, toString: a}
            if ('none' == t)
            ...
            (function(t) {
              ...
              ;(t.add = function(t, e, r, i, n, a) {
                ...
                for (
                  t &&
                    t instanceof g &&
                    (l = [[t.a, t.c, t.e], [t.b, t.d, t.f], [0, 0, 1]]),
                    h = 0;
                  h < 3;
                  h++
                )
          ...
          var _e = function(t) {
            var e = t.getBoundingClientRect(),
              ...
              l =
                e.left + (T.win.pageXOffset || n.scrollLeft || i.scrollLeft) - s
            return {y: o, x: l}
          }
                      ...
                      case 'clip-rect':
                        ...
                        if (4 == C.length) {
                          ...
                          var A = v('clipPath'),
                            T = v('rect')
                          ;(A.id = t.createUUID()),
                            v(T, {x: C[0], y: C[1], width: C[2], height: C[3]}),
                            A.appendChild(T),
            ...
            ;(T.prototype = E),
              ...
              (E.remove = function() {
                ...
                if (!this.removed && e.parentNode) {
                  ...
                  for (var i in this)
                    this[i] =
                      'function' == typeof this[i] ? t._removedFactory(i) : null
                  this.removed = !0
                }
              }),
              (E._getBBox = function() {
